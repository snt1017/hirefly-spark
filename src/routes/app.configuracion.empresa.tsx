...
function CompanySettings() {
  ...
  const save = () => {
    ...
    posthog.capture("company_settings_saved", { has_logo: !!logoPreview });
  ...
  const reset = () => {
    setForm({
      ...form,
      primaryColor: demoCompany.primaryColor,
      secondaryColor: demoCompany.secondaryColor,
    });
            ...
            <Card title="Identidad visual">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <p className="text-xs text-muted-foreground">
                  La previsualización es local. No se sube ningún archivo.
                </p>
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card">
              <div
                ...
                style={{ borderBottom: `1px solid ${form.primaryColor}22` }}
              >
                <div className="flex items-center gap-2">
                  <CompanyLogo
                    ...
                    size={28}
                  />
                  <span className="text-sm font-semibold" style={{ color: form.secondaryColor }}>
                    {form.name}
                  </span>
                </div>
                <span
